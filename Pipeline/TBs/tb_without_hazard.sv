module tb_without_hazard;
    ...
    initial begin
        $display("=================================================");
        $display("Starting Simulation for without_hazard.hex");
        // Load the memory
        for (integer i=0; i<32; i=i+1) begin
            uut.u_instruction_memory.instruction_memory_reg[i] = 32'h0;
        end
        $readmemh("c:/Users/Moosa/Desktop/3 Stage Pipeline/without_hazard.hex", uut.u_instruction_memory.instruction_memory_reg);
        
        reset = 1'b1;
        #30;
        reset = 1'b0;
        
        #500; // run for enough cycles
